...
public class FileProvider extends ContentProvider {
    /* renamed from: a */
    private static final String[] f1294a = new String[]{"_display_name", "_size"};
    /* renamed from: b */
    private static final File f1295b = new File("/");
    /* renamed from: c */
    private static HashMap<String, C0374a> f1296c = new HashMap();
    /* renamed from: d */
    private C0374a f1297d;

    /* renamed from: android.support.v4.content.FileProvider$a */
    interface C0374a {
        /* renamed from: a */
        Uri mo318a(File file);
    ...
    static class C3119b implements C0374a {
        /* renamed from: a */
        private final String f13208a;
        /* renamed from: b */
        private final HashMap<String, File> f13209b = new HashMap();
        ...
        /* renamed from: a */
        void m15571a(String str, File file) {
            if (TextUtils.isEmpty(str)) {
                throw new IllegalArgumentException("Name must not be empty");
            }
            try {
                this.f13209b.put(str, file.getCanonicalFile());
            } catch (String str2) {
        ...
        /* renamed from: a */
        public android.net.Uri mo318a(java.io.File r6) {
...
*/
        ...
        /* renamed from: a */
        public java.io.File mo319a(android.net.Uri r5) {
            /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        if (providerInfo.exported) {
            ...
            this.f1297d = m1380a(context, providerInfo.authority);
        } else {
    ...
    /* renamed from: a */
    public static Uri m1379a(Context context, String str, File file) {
        return m1380a(context, str).mo318a(file);
    }

    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        uri = this.f1297d.mo319a(uri);
        if (strArr == null) {
            strArr = f1294a;
        }
        ...
        uri = m1383a(strArr3, i);
        strArr = m1382a(objArr, i);
    ...
    public int delete(Uri uri, String str, String[] strArr) {
        return this.f1297d.mo319a(uri).delete();
    }

    public ParcelFileDescriptor openFile(Uri uri, String str) {
        return ParcelFileDescriptor.open(this.f1297d.mo319a(uri), m1378a(str));
    }

    /* renamed from: a */
    private static C0374a m1380a(Context context, String str) {
        C0374a c0374a;
        synchronized (f1296c) {
            c0374a = (C0374a) f1296c.get(str);
            if (c0374a == null) {
                try {
                    c0374a = m1384b(context, str);
                    f1296c.put(str, c0374a);
    ...
    /* renamed from: b */
    private static C0374a m1384b(Context context, String str) {
        C0374a c3119b = new C3119b(str);
            ...
            while (true) {
                ...
                if (next == 2) {
                    ...
                    if ("root-path".equals(name)) {
                        ...
                        r1 = C0389b.m1434a(context, null);
                        if (r1.length > 0) {
                            file = r1[0];
                        }
                    } else if ("external-cache-path".equals(name)) {
                        r1 = C0389b.m1433a(context);
                        if (r1.length > 0) {
                            file = r1[0];
                        }
                    ...
                    if (file != null) {
                        c3119b.m15571a(attributeValue, m1381a(file, attributeValue2));
                    }
                }
            }
        } else {
    ...
    /* renamed from: a */
    private static int m1378a(String str) {
        if ("r".equals(str)) {
            return 268435456;
        }
        if (!"w".equals(str)) {
    ...
    /* renamed from: a */
    private static File m1381a(File file, String... strArr) {
    ...
    /* renamed from: a */
    private static String[] m1383a(String[] strArr, int i) {
    ...
    /* renamed from: a */
    private static Object[] m1382a(Object[] objArr, int i) {
