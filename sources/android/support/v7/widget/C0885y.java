...
public class C0885y {
    /* renamed from: a */
    public static final Rect f3015a = new Rect();
    /* renamed from: b */
    private static Class<?> f3016b;
...
*/
    ...
    L_0x000d:
        ...
        f3016b = r0;	 Catch:{ ClassNotFoundException -> 0x0015 }
    L_0x0015:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.y.<clinit>():void");
    }

    /* renamed from: a */
    public static android.graphics.Rect m3862a(android.graphics.drawable.Drawable r10) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x0004:
        r10 = android.support.v4.p009a.p010a.C0295a.m1062h(r10);	 Catch:{ Exception -> 0x0098 }
    ...
    L_0x001d:
        ...
        r1 = f3016b;	 Catch:{ Exception -> 0x0098 }
    ...
    L_0x009f:
        ...
        return r10;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.y.a(android.graphics.drawable.Drawable):android.graphics.Rect");
    }

    /* renamed from: b */
    static void m3863b(Drawable drawable) {
        if (VERSION.SDK_INT == 21 && "android.graphics.drawable.VectorDrawable".equals(drawable.getClass().getName())) {
            C0885y.m3865d(drawable);
        }
    }

    /* renamed from: c */
    public static boolean m3864c(Drawable drawable) {
        ...
        if (drawable instanceof DrawableContainer) {
            ...
            return C0885y.m3864c(((C0297c) drawable).mo248a());
        } else {
            if (drawable instanceof C0682a) {
                return C0885y.m3864c(((C0682a) drawable).m2711b());
            }
            if (drawable instanceof ScaleDrawable) {
                return C0885y.m3864c(((ScaleDrawable) drawable).getDrawable());
            }
        }
        return true;
    }
    ...
    /* renamed from: d */
    private static void m3865d(Drawable drawable) {
        int[] state = drawable.getState();
        if (state != null) {
            if (state.length != 0) {
                drawable.setState(at.f2838h);
                drawable.setState(state);
            }
        }
        drawable.setState(at.f2835e);
        drawable.setState(state);
    }

    /* renamed from: a */
    public static Mode m3861a(int i, Mode mode) {
        if (i == 3) {
