...
/* renamed from: com.cuvora.carinfo.e.f */
public class C4544f extends C3666b {
    public C4544f(ViewGroup viewGroup) {
        super(viewGroup, (int) R.layout.row_recent_searches);
    }

    /* renamed from: a */
    public void m25047a(final VehicleSearchResult vehicleSearchResult, final C1475a c1475a) {
        ...
        imageView.setOnClickListener(new OnClickListener(this) {
            /* renamed from: c */
            final /* synthetic */ C4544f f4468c;

            public void onClick(View view) {
                c1475a.mo1194a(vehicleSearchResult, false);
            }
        });
        this.a.setOnClickListener(new OnClickListener(this) {
            /* renamed from: c */
            final /* synthetic */ C4544f f4471c;

            public void onClick(View view) {
                c1475a.mo1197b(vehicleSearchResult);
            }
        });
    }
}
