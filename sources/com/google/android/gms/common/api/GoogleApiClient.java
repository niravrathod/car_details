...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            this.zabx = new C3131a();
            this.zaby = new C3131a();
            this.zaca = -1;
            this.zacc = GoogleApiAvailability.getInstance();
            this.zacd = zaa.f10810a;
        ...
        public final ClientSettings buildClientSettings() {
            SignInOptions signInOptions = SignInOptions.f21438a;
            if (this.zaby.containsKey(zaa.f10811b)) {
                signInOptions = (SignInOptions) this.zaby.get(zaa.f10811b);
            }
        ...
        public final GoogleApiClient build() {
            ...
            for (Api api2 : this.zaby.keySet()) {
                ...
                c3131a.put(api2, Boolean.valueOf(z));
                ...
                c3131a2.put(api3.getClientKey(), buildClient);
            ...
            GoogleApiClient zaaw = new zaaw(r1.mContext, new ReentrantLock(), r1.zabj, buildClientSettings, r1.zacc, r1.zacd, c3131a, r1.zace, r1.zacf, c3131a2, r1.zaca, zaaw.zaa(c3131a2.values(), true), arrayList, false);
