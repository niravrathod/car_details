...
public class GoogleApiAvailabilityLight {
    ...
    public int isGooglePlayServicesAvailable(Context context, int i) {
        ...
        return GooglePlayServicesUtilLight.isPlayServicesPossiblyUpdating(context, i) != null ? 18 : i;
    }
    ...
    public Intent getErrorResolutionIntent(Context context, int i, String str) {
        switch (i) {
            case 1:
            case 2:
                if (context == null || DeviceProperties.isWearableWithoutPlayStore(context) == 0) {
    ...
    public PendingIntent getErrorResolutionPendingIntent(Context context, int i, int i2, String str) {
        i = getErrorResolutionIntent(context, i, str);
        if (i == 0) {
            return null;
        }
    ...
    private static java.lang.String zza(android.content.Context r2, java.lang.String r3) {
