...
public class C0306h {
    /* renamed from: a */
    public static java.io.File m1097a(android.content.Context r5) {
...
*/
    ...
    /* renamed from: a */
    private static java.nio.ByteBuffer m1100a(java.io.File r9) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    /* renamed from: a */
    public static java.nio.ByteBuffer m1099a(android.content.Context r8, android.os.CancellationSignal r9, android.net.Uri r10) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    /* renamed from: a */
    public static ByteBuffer m1098a(Context context, Resources resources, int i) {
        File a = C0306h.m1097a(context);
        if (a == null) {
            return null;
        }
        try {
            if (C0306h.m1102a(a, resources, i) == null) {
                return null;
            }
            resources = C0306h.m1100a(a);
            a.delete();
            return resources;
        } finally {
            a.delete();
    ...
    /* renamed from: a */
    public static boolean m1103a(File file, InputStream inputStream) {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (read != -1) {
                        ...
                        C0306h.m1101a(fileOutputStream);
                        return true;
                    }
                }
            } catch (IOException e) {
    ...
    /* renamed from: a */
    public static boolean m1102a(File file, Resources resources, int i) {
        Closeable openRawResource;
        try {
            openRawResource = resources.openRawResource(i);
            try {
                file = C0306h.m1103a(file, openRawResource);
                C0306h.m1101a(openRawResource);
                return file;
            } catch (Throwable th) {
                file = th;
                C0306h.m1101a(openRawResource);
    ...
    /* renamed from: a */
    public static void m1101a(java.io.Closeable r0) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
