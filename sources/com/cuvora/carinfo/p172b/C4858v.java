...
/* renamed from: com.cuvora.carinfo.b.v */
public class C4858v extends C4798u implements C1489a {
    /* renamed from: h */
    private static final C0052b f21533h = null;
    /* renamed from: i */
    private static final SparseIntArray f21534i = null;
    /* renamed from: j */
    private final ConstraintLayout f21535j;
    /* renamed from: k */
    private final OnClickListener f21536k;
    /* renamed from: l */
    private long f21537l;

    public C4858v(C0059e c0059e, View view) {
        this(c0059e, view, ViewDataBinding.m24012a(c0059e, view, 4, f21533h, f21534i));
    }

    private C4858v(C0059e c0059e, View view, Object[] objArr) {
        super(c0059e, view, 0, (RecyclerView) objArr[3], (TextView) objArr[1], (TextView) objArr[2]);
        this.f21537l = -1;
        this.c.setTag(null);
        this.d.setTag(null);
        this.f21535j = (ConstraintLayout) objArr[null];
        this.f21535j.setTag(null);
        this.e.setTag(null);
        m24022a(view);
        this.f21536k = new C1490a(this, 1);
        mo4906h();
    }
    ...
    public boolean mo4903a(int i, Object obj) {
        if (2 == i) {
            ...
            m28813a((HomeFragmentViewModel) obj);
        }
        return true;
    }

    /* renamed from: a */
    public void m28812a(C3729b c3729b) {
        this.f = c3729b;
        synchronized (this) {
            this.f21537l |= 1;
        }
    ...
    /* renamed from: a */
    public void m28813a(HomeFragmentViewModel homeFragmentViewModel) {
    ...
    protected void mo4904b() {
        ...
        if ((j & 4) != 0) {
            this.e.setOnClickListener(this.f21536k);
        }
    }
