...
/* renamed from: com.cuvora.carinfo.b.j */
public class C4852j extends C4792i implements C1489a {
    /* renamed from: h */
    private static final C0052b f21508h = null;
    /* renamed from: i */
    private static final SparseIntArray f21509i = null;
    /* renamed from: j */
    private final OnClickListener f21510j;
    /* renamed from: k */
    private long f21511k;

    public C4852j(C0059e c0059e, View view) {
        this(c0059e, view, ViewDataBinding.m24012a(c0059e, view, 3, f21508h, f21509i));
    }

    private C4852j(C0059e c0059e, View view, Object[] objArr) {
        ...
        this.e.setTag(null);
        m24022a(view);
        this.f21510j = new C1490a(this, 1);
        mo4906h();
    }
    ...
    public boolean mo4903a(int i, Object obj) {
        if (2 == i) {
            ...
            m28771a((HomeFragmentViewModel) obj);
        }
        return true;
    }

    /* renamed from: a */
    public void m28770a(C3730d c3730d) {
        this.f = c3730d;
        synchronized (this) {
            this.f21511k |= 1;
        }
    ...
    /* renamed from: a */
    public void m28771a(HomeFragmentViewModel homeFragmentViewModel) {
    ...
    protected void mo4904b() {
        ...
        if ((j & 4) != 0) {
            this.e.setOnClickListener(this.f21510j);
        }
    }
