...
public final class zzbhv {
    /* renamed from: a */
    private static String f9272a;

    /* renamed from: a */
    public static String m10460a(Context context) {
        if (f9272a != null) {
            return f9272a;
        }
        ...
        if (arrayList.isEmpty()) {
            ...
            f9272a = (String) arrayList.get(0);
        } else if (!TextUtils.isEmpty(obj) && m10461a(context, intent) == null && arrayList.contains(obj) != null) {
            f9272a = obj;
        } else if (arrayList.contains("com.android.chrome") != null) {
            f9272a = "com.android.chrome";
        } else if (arrayList.contains("com.chrome.beta") != null) {
            f9272a = "com.chrome.beta";
        } else if (arrayList.contains("com.chrome.dev") != null) {
            f9272a = "com.chrome.dev";
        } else if (arrayList.contains("com.google.android.apps.chrome") != null) {
            f9272a = "com.google.android.apps.chrome";
        }
        return f9272a;
    }

    /* renamed from: a */
    private static boolean m10461a(android.content.Context r3, android.content.Intent r4) {
...
*/
    ...
    L_0x0042:
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbhv.a(android.content.Context, android.content.Intent):boolean");
    }
}
