...
public final class SignInButton extends FrameLayout implements OnClickListener {
    ...
    public SignInButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zaat = 0;
        context = context.getTheme().obtainStyledAttributes(attributeSet, C2428R.styleable.SignInButton, 0, 0);
        try {
            this.mSize = context.getInt(C2428R.styleable.SignInButton_buttonSize, 0);
            this.mColor = context.getInt(C2428R.styleable.SignInButton_colorScheme, 2);
