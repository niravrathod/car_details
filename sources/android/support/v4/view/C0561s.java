...
*/
    ...
    L_0x0006:
        ...
        f1775a = r0;	 Catch:{ Exception -> 0x0014 }
        goto L_0x001b;
    L_0x0014:
        r0 = "ViewConfigCompat";
    ...
    /* renamed from: a */
    public static float m2215a(ViewConfiguration viewConfiguration, Context context) {
        if (VERSION.SDK_INT >= 26) {
            return viewConfiguration.getScaledHorizontalScrollFactor();
        }
        return C0561s.m2217c(viewConfiguration, context);
    }

    /* renamed from: b */
    public static float m2216b(ViewConfiguration viewConfiguration, Context context) {
        if (VERSION.SDK_INT >= 26) {
    ...
    /* renamed from: c */
    private static float m2217c(android.view.ViewConfiguration r3, android.content.Context r4) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x000a:
        r0 = f1775a;	 Catch:{ Exception -> 0x001b }
