...
public class C1952g {
    ...
    /* renamed from: a */
    public static void m7374a(com.facebook.ads.internal.p101q.p104c.C1952g r3, android.content.Context r4, android.net.Uri r5, java.lang.String r6) {
...
*/
        /*
        r0 = r5.getScheme();
        r0 = com.facebook.ads.internal.p101q.p104c.C1952g.m7376a(r0);
    ...
    L_0x0028:
        ...
        goto L_0x002f;
    L_0x002c:
        r3.m7380a(r4, r5);	 Catch:{ c -> 0x0028 }
    L_0x002f:
        return;
        */
    ...
    /* renamed from: a */
    private boolean m7375a(Context context) {
    ...
    /* renamed from: a */
    private static boolean m7376a(String str) {
    ...
    /* renamed from: b */
    private void m7377b(Context context, Uri uri) {
        context.startActivity(m7379c(context, uri));
    }

    /* renamed from: b */
    private void m7378b(android.content.Context r4, android.net.Uri r5, java.lang.String r6) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
        ...
        r0.addFlags(r1);
        r1 = "viewType";
        r2 = com.facebook.ads.internal.settings.C1963a.C1962a.BROWSER;
        r0.putExtra(r1, r2);
        r1 = "browserURL";
        r2 = r5.toString();
        r0.putExtra(r1, r2);
    ...
    /* renamed from: c */
    private Intent m7379c(Context context, Uri uri) {
        Intent a = m7373a(uri);
    ...
    /* renamed from: a */
    public void m7380a(Context context, Uri uri) {
        if (m7375a(context)) {
            Intent c = m7379c(context, uri);
    ...
    /* renamed from: a */
    public void m7381a(Context context, Uri uri, String str) {
        if (C1952g.m7376a(uri.getScheme()) && C1820a.m6852g(context)) {
            m7378b(context, uri, str);
        } else {
            m7377b(context, uri);
        }
    }
