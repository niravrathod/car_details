...
/* renamed from: com.cuvora.carinfo.b.ab */
public class ab extends aa implements C1489a {
    /* renamed from: h */
    private static final C0052b f21479h = null;
    /* renamed from: i */
    private static final SparseIntArray f21480i = null;
    /* renamed from: j */
    private final ConstraintLayout f21481j;
    /* renamed from: k */
    private final OnClickListener f21482k;
    /* renamed from: l */
    private long f21483l;

    public ab(C0059e c0059e, View view) {
        this(c0059e, view, ViewDataBinding.m24012a(c0059e, view, 4, f21479h, f21480i));
    }

    private ab(C0059e c0059e, View view, Object[] objArr) {
        super(c0059e, view, 0, (RecyclerView) objArr[3], (TextView) objArr[1], (TextView) objArr[2]);
        this.f21483l = -1;
        this.c.setTag(null);
        this.d.setTag(null);
        this.f21481j = (ConstraintLayout) objArr[null];
        this.f21481j.setTag(null);
        this.e.setTag(null);
        m24022a(view);
        this.f21482k = new C1490a(this, 1);
        mo4906h();
    }
    ...
    public boolean mo4903a(int i, Object obj) {
        if (2 == i) {
            ...
            m28729a((HomeFragmentViewModel) obj);
        }
        return true;
    }

    /* renamed from: a */
    public void m28728a(C3729b c3729b) {
        this.f = c3729b;
        synchronized (this) {
            this.f21483l |= 1;
        }
    ...
    /* renamed from: a */
    public void m28729a(HomeFragmentViewModel homeFragmentViewModel) {
    ...
    protected void mo4904b() {
        ...
        if ((j & 4) != 0) {
            ...
            this.e.setOnClickListener(this.f21482k);
        }
        if (j3 != 0) {
