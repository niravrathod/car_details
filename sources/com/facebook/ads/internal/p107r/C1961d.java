...
class C1961d {
    /* renamed from: a */
    static Float m7429a(View view) {
        Activity a = C1906a.m7249a();
        if (a == null) {
            return null;
        }
        ...
        if (!(findViewById == null || view == null)) {
            if (view.getId() != -1) {
                return findViewById.findViewById(view.getId()) == null ? Float.valueOf(-1.0f) : C1961d.m7430a(findViewById, view);
            }
        }
        return null;
    }
    ...
    /* renamed from: a */
    static Float m7430a(View view, View view2) {
        if (view != null) {
            if (view2 != null) {
                ...
                float f;
                List<View> b = C1961d.m7432b(view, view2);
                if (b.isEmpty()) {
                    f = 1.0f;
                } else {
                    Rect rect = new Rect();
                    ...
                    for (View view3 : b) {
                        ...
                        if (view3.getGlobalVisibleRect(rect2)) {
                            ...
                            for (Rect a : r1) {
                                hashSet2.addAll(C1961d.m7431a(a, rect2));
                            }
                            hashSet = hashSet2;
                        }
                    }
    ...
    /* renamed from: a */
    static Set<Rect> m7431a(Rect rect, Rect rect2) {
    ...
    /* renamed from: b */
    private static List<View> m7432b(View view, View view2) {
