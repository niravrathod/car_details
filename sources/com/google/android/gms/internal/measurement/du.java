...
final class du extends dt {
    ...
    /* renamed from: a */
    final int mo3108a(int i, byte[] bArr, int i2, int i3) {
        ...
        if (((i | i2) | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (i < i4) {
                ...
                if (ds.m11810d(b2)) {
                    ...
                    i = i5;
                    i6 = i7;
                } else if (ds.m11811e(b2)) {
                    if (i5 < i4) {
                        i7 = i5 + 1;
                        i3 = i6 + 1;
                        ds.m11806b(b2, bArr[i5], i2, i6);
                        i = i7;
                        i6 = i3;
                    } else {
                        throw zzvt.m12088h();
                    }
                } else if (ds.m11812f(b2)) {
                    if (i5 < i4 - 1) {
                        i7 = i5 + 1;
                        i3 = i7 + 1;
                        int i8 = i6 + 1;
                        ds.m11805b(b2, bArr[i5], bArr[i7], i2, i6);
                        i = i3;
                        i6 = i8;
                    } else {
                        throw zzvt.m12088h();
                    ...
                    int i9 = i5 + 1;
                    int i10 = i6 + 1;
                    ds.m11804b(b2, b3, bArr[i7], bArr[i5], i2, i6);
                    i = i9;
                    i6 = i10 + 1;
                } else {
                    throw zzvt.m12088h();
