...
public final class SearchAdRequest {
    ...
    /* renamed from: a */
    private final zzmg f7857a;
    /* renamed from: b */
    private final String f7858b;

    public static final class Builder {
        /* renamed from: a */
        private final zzmh f7855a = new zzmh();
        /* renamed from: b */
        ...
        public final Builder addNetworkExtras(NetworkExtras networkExtras) {
            this.f7855a.m10791a(networkExtras);
            return this;
        }

        public final Builder addNetworkExtrasBundle(Class<? extends MediationAdapter> cls, Bundle bundle) {
            this.f7855a.m10792a((Class) cls, bundle);
            return this;
        }

        public final Builder addCustomEventExtrasBundle(Class<? extends CustomEvent> cls, Bundle bundle) {
            this.f7855a.m10797b(cls, bundle);
            return this;
        }

        public final Builder addTestDevice(String str) {
            this.f7855a.m10798b(str);
            return this;
        }
        ...
        public final Builder setRequestAgent(String str) {
            this.f7855a.m10804f(str);
            return this;
        }

        public final Builder tagForChildDirectedTreatment(boolean z) {
            this.f7855a.m10799b(z);
            return this;
        }
    }

    private SearchAdRequest(Builder builder) {
        this.f7858b = builder.f7856b;
        this.f7857a = new zzmg(builder.f7855a, this);
    }
    ...
    public final Location getLocation() {
        return this.f7857a.m10761e();
    }

    @Deprecated
    public final <T extends NetworkExtras> T getNetworkExtras(Class<T> cls) {
        return this.f7857a.m10753a((Class) cls);
    }

    public final <T extends MediationAdapter> Bundle getNetworkExtrasBundle(Class<T> cls) {
        return this.f7857a.m10756b(cls);
    }

    public final <T extends CustomEvent> Bundle getCustomEventExtrasBundle(Class<T> cls) {
        return this.f7857a.m10759c(cls);
    }
    ...
    public final boolean isTestDevice(Context context) {
        return this.f7857a.m10755a(context);
    }
