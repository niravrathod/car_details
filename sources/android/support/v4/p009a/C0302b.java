...
public class C0302b {
    ...
    public static class C0301b {
        ...
        C0301b(char c, float[] fArr) {
            this.f1049a = c;
            this.f1050b = fArr;
        }

        C0301b(C0301b c0301b) {
            this.f1049a = c0301b.f1049a;
            this.f1050b = C0302b.m1082a(c0301b.f1050b, 0, c0301b.f1050b.length);
        }

        /* renamed from: a */
        public static void m1075a(C0301b[] c0301bArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < c0301bArr.length; i++) {
                C0301b.m1074a(path, fArr, c, c0301bArr[i].f1049a, c0301bArr[i].f1050b);
                c = c0301bArr[i].f1049a;
            }
        }

        /* renamed from: a */
        public void m1076a(C0301b c0301b, C0301b c0301b2, float f) {
            for (int i = 0; i < c0301b.f1050b.length; i++) {
                this.f1050b[i] = (c0301b.f1050b[i] * (1.0f - f)) + (c0301b2.f1050b[i] * f);
            }
        }
        ...
        /* renamed from: a */
        private static void m1074a(android.graphics.Path r27, float[] r28, char r29, char r30, float[] r31) {
            /*
            r10 = r27;
            r13 = r31;
            r14 = 0;
        ...
        L_0x0185:
            ...
            r25 = r9;
            r9 = r26;
            android.support.v4.p009a.C0302b.C0301b.m1073a(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9);
            r0 = r13[r14];
            r8 = r11 + r0;
            r0 = r13[r15];
            r7 = r12 + r0;
        ...
        L_0x02f0:
            ...
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.v4.a.b.b.a(android.graphics.Path, float[], char, char, float[]):void");
        }

        /* renamed from: a */
        private static void m1073a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            float f8 = f;
            float f9 = f3;
            float f10 = f5;
            float f11 = f6;
            ...
            if (d14 < 0.0d) {
                ...
                C0301b.m1073a(path, f, f2, f3, f4, f10 * f8, f6 * f8, f7, z, z2);
                return;
            }
            sin = Math.sqrt(d14);
            d5 *= sin;
            ...
            Double.isNaN(d);
            d12 *= d;
            C0301b.m1072a(path, (d11 * cos) - (d12 * d13), (d11 * d13) + (d12 * cos), d9, d, d3, d6, toRadians, d8, d15);
        }

        /* renamed from: a */
        private static void m1072a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            double d10 = d3;
    ...
    /* renamed from: a */
    static float[] m1082a(float[] fArr, int i, int i2) {
        if (i <= i2) {
    ...
    /* renamed from: a */
    public static Path m1078a(String str) {
        Path path = new Path();
        C0301b[] b = C0302b.m1085b(str);
        if (b == null) {
            return null;
        }
        try {
            C0301b.m1075a(b, path);
            return path;
        } catch (Throwable e) {
            StringBuilder stringBuilder = new StringBuilder();
    ...
    /* renamed from: b */
    public static C0301b[] m1085b(String str) {
        if (str == null) {
            return null;
        }
        ...
        int i2 = 0;
        while (i < str.length()) {
            i = C0302b.m1077a(str, i);
            String trim = str.substring(i2, i).trim();
            if (trim.length() > 0) {
                C0302b.m1080a(arrayList, trim.charAt(0), C0302b.m1086c(trim));
            }
            i2 = i;
            i++;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            C0302b.m1080a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C0301b[]) arrayList.toArray(new C0301b[arrayList.size()]);
    }

    /* renamed from: a */
    public static C0301b[] m1083a(C0301b[] c0301bArr) {
        if (c0301bArr == null) {
            return null;
        }
        C0301b[] c0301bArr2 = new C0301b[c0301bArr.length];
        for (int i = 0; i < c0301bArr.length; i++) {
            c0301bArr2[i] = new C0301b(c0301bArr[i]);
        }
        return c0301bArr2;
    }

    /* renamed from: a */
    public static boolean m1081a(C0301b[] c0301bArr, C0301b[] c0301bArr2) {
        if (c0301bArr != null) {
            if (c0301bArr2 != null) {
                if (c0301bArr.length != c0301bArr2.length) {
                    return false;
                }
                int i = 0;
                while (i < c0301bArr.length) {
                    if (c0301bArr[i].f1049a == c0301bArr2[i].f1049a) {
                        if (c0301bArr[i].f1050b.length == c0301bArr2[i].f1050b.length) {
                            i++;
                        }
                    }
                    return false;
    ...
    /* renamed from: b */
    public static void m1084b(C0301b[] c0301bArr, C0301b[] c0301bArr2) {
        for (int i = 0; i < c0301bArr2.length; i++) {
            c0301bArr[i].f1049a = c0301bArr2[i].f1049a;
            for (int i2 = 0; i2 < c0301bArr2[i].f1050b.length; i2++) {
                c0301bArr[i].f1050b[i2] = c0301bArr2[i].f1050b[i2];
            }
        }
    }

    /* renamed from: a */
    private static int m1077a(String str, int i) {
        while (i < str.length()) {
    ...
    /* renamed from: a */
    private static void m1080a(ArrayList<C0301b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0301b(c, fArr));
    }

    /* renamed from: c */
    private static float[] m1086c(String str) {
        if (str.charAt(0) != 'z') {
            if (str.charAt(0) != 'Z') {
                try {
                    ...
                    int i2 = 0;
                    while (i < length) {
                        C0302b.m1079a(str, i, c0300a);
                        int i3 = c0300a.f1047a;
                        if (i < i3) {
                            int i4 = i2 + 1;
                            fArr[i2] = Float.parseFloat(str.substring(i, i3));
                            i2 = i4;
                        }
                        i = c0300a.f1048b ? i3 : i3 + 1;
                    }
                    return C0302b.m1082a(fArr, 0, i2);
                } catch (Throwable e) {
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("error in parsing \"");
                    stringBuilder.append(str);
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    /* renamed from: a */
    private static void m1079a(java.lang.String r8, int r9, android.support.v4.p009a.C0302b.C0300a r10) {
        /*
        r0 = 0;
        r10.f1048b = r0;
        r1 = r9;
    ...
    L_0x003d:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.a.b.a(java.lang.String, int, android.support.v4.a.b$a):void");
    }
}
