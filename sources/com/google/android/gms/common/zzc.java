    ...
    private static zzm zzb(String str, zze zze, boolean z) {
        try {
            if (zzn == null) {
                ...
                synchronized (zzo) {
                    if (zzn == null) {
                        zzn = zzn.zzc(DynamiteModule.m8886a(zzp, DynamiteModule.f7882c, "com.google.android.gms.googlecertificates").m8898a("com.google.android.gms.common.GoogleCertificatesImpl"));
                    }
                }
            }
            Preconditions.checkNotNull(zzp);
            try {
                if (zzn.zza(new zzk(str, zze, z), ObjectWrapper.m26019a(zzp.getPackageManager()))) {
                    return zzm.zze();
                }
