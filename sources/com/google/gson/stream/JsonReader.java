...
import com.google.gson.internal.bind.C4236c;
...
public class JsonReader implements Closeable {
    ...
    static class C42601 extends C2648c {
        C42601() {
        }

        public void promoteNameToValue(JsonReader jsonReader) {
            if (jsonReader instanceof C4236c) {
                ((C4236c) jsonReader).m23215a();
                return;
            }
