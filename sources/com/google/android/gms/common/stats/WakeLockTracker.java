...
public class WakeLockTracker {
    ...
    public void registerEvent(Context context, String str, int i, String str2, String str3, String str4, int i2, List<String> list, long j) {
        ...
        if (7 == i3 || 8 == i3 || 10 == i3 || 11 == i3) {
            ...
            WakeLockEvent wakeLockEvent2 = new WakeLockEvent(currentTimeMillis, i, str2, i2, list3, str, elapsedRealtime, zzg, str3, "com.google.android.gms".equals(str6) ? null : str6, zza.zzh(context), j, str4);
            try {
