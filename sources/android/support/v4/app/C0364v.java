...
public final class C0364v {
    ...
    /* renamed from: a */
    public static android.content.Intent m1326a(android.app.Activity r4) {
...
*/
    ...
    L_0x000c:
        return r0;
    L_0x000d:
        r0 = android.support.v4.app.C0364v.m1329b(r4);
        r1 = 0;
    ...
    L_0x0015:
        ...
        r2.<init>(r4, r0);
        r4 = android.support.v4.app.C0364v.m1330b(r4, r2);	 Catch:{ NameNotFoundException -> 0x002f }
    ...
    public static Intent m1327a(Context context, ComponentName componentName) {
        String b = C0364v.m1330b(context, componentName);
        if (b == null) {
            return null;
        }
        ComponentName componentName2 = new ComponentName(componentName.getPackageName(), b);
        if (C0364v.m1330b(context, componentName2) == null) {
    ...
    public static String m1329b(Activity activity) {
        try {
            return C0364v.m1330b((Context) activity, activity.getComponentName());
