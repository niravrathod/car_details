...
public final class zzagj implements Creator<zzagi> {
    ...
    public final /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        Bundle bundle = null;
        zzaop zzaop = bundle;
        ApplicationInfo applicationInfo = zzaop;
        ...
        while (parcel.dataPosition() < validateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(readHeader)) {
                case 1:
                    ...
                    break;
                case 2:
                    zzaop = (zzaop) SafeParcelReader.createParcelable(parcel, readHeader, zzaop.CREATOR);
                    break;
                case 3:
        ...
        return new zzagi(bundle, zzaop, applicationInfo, str, list, packageInfo, str2, z, str3);
    }
}
