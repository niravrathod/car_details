    ...
    protected Builder createClientSettingsBuilder() {
        ...
        if (this.zabh instanceof HasGoogleSignInAccountOptions) {
            ...
            if (googleSignInAccount != null) {
                d = googleSignInAccount.m25984d();
                builder = builder.setAccount(d);
                if (this.zabh instanceof HasGoogleSignInAccountOptions) {
                    googleSignInAccount = ((HasGoogleSignInAccountOptions) this.zabh).getGoogleSignInAccount();
                    if (googleSignInAccount != null) {
                        j = googleSignInAccount.m25990j();
                        return builder.addAllRequiredScopes(j).setRealClientClassName(this.mContext.getClass().getName()).setRealClientPackageName(this.mContext.getPackageName());
                    }
                }
        ...
        d = this.zabh instanceof HasAccountOptions ? ((HasAccountOptions) this.zabh).getAccount() : null;
        builder = builder.setAccount(d);
        if (this.zabh instanceof HasGoogleSignInAccountOptions) {
            googleSignInAccount = ((HasGoogleSignInAccountOptions) this.zabh).getGoogleSignInAccount();
            if (googleSignInAccount != null) {
