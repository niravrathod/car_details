...
public class C4432h extends Fragment implements OnCancelListener, OnDismissListener {
    ...
    public void show(C0334l c0334l, String str) {
        ...
        c0334l = c0334l.mo292a();
        c0334l.mo271a((Fragment) this, str);
        c0334l.mo278c();
    }

    public int show(C0347q c0347q, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        c0347q.mo271a((Fragment) this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = c0347q.mo278c();
        return this.mBackStackId;
    }

    public void showNow(C0334l c0334l, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        c0334l = c0334l.mo292a();
        c0334l.mo271a((Fragment) this, str);
    ...
    void dismissInternal(boolean z) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().mo293a(this.mBackStackId, 1);
                this.mBackStackId = true;
            } else {
                C0347q a = getFragmentManager().mo292a();
                a.mo270a((Fragment) this);
                if (z) {
                    a.mo280d();
                } else {
                    a.mo278c();
    ...
    public LayoutInflater onGetLayoutInflater(Bundle bundle) {
        ...
        if (this.mDialog == null) {
            return (LayoutInflater) this.mHost.m15390i().getSystemService("layout_inflater");
        }
