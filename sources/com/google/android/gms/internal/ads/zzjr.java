...
import com.google.android.gms.ads.C2391R;

@zzaer
public final class zzjr {
    /* renamed from: a */
    private final AdSize[] f9566a;
    /* renamed from: b */
    private final String f9567b;

    /* renamed from: a */
    private static com.google.android.gms.ads.AdSize[] m10693a(java.lang.String r10) {
...
*/
    ...
    L_0x00f0:
        r4 = com.google.android.gms.ads.AdSize.zzva;
        r1[r3] = r4;
    L_0x00f4:
        r3 = r3 + 1;
        goto L_0x000b;
    ...
    L_0x0134:
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzjr.a(java.lang.String):com.google.android.gms.ads.AdSize[]");
    }

    public zzjr(Context context, AttributeSet attributeSet) {
        context = context.getResources().obtainAttributes(attributeSet, C2391R.styleable.AdsAttrs);
        String string = context.getString(C2391R.styleable.AdsAttrs_adSize);
        String string2 = context.getString(C2391R.styleable.AdsAttrs_adSizes);
        int isEmpty = TextUtils.isEmpty(string) ^ 1;
        int isEmpty2 = TextUtils.isEmpty(string2) ^ 1;
        if (isEmpty != 0 && isEmpty2 == 0) {
            this.f9566a = m10693a(string);
        } else if (isEmpty == 0 && isEmpty2 != 0) {
            this.f9566a = m10693a(string2);
        } else if (isEmpty != 0) {
            throw new IllegalArgumentException("Either XML attribute \"adSize\" or XML attribute \"supportedAdSizes\" should be specified, but not both.");
        } else {
            throw new IllegalArgumentException("Required XML attribute \"adSize\" was missing.");
        }
        this.f9567b = context.getString(C2391R.styleable.AdsAttrs_adUnitId);
        if (TextUtils.isEmpty(this.f9567b) != null) {
            throw new IllegalArgumentException("Required XML attribute \"adUnitId\" was missing.");
        }
    }

    /* renamed from: a */
    public final AdSize[] m10695a(boolean z) {
        if (!z) {
            if (!this.f9566a.length) {
