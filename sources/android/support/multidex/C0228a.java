...
public final class C0228a {
    /* renamed from: a */
    private static final Set<File> f851a = new HashSet();
    /* renamed from: b */
    private static final boolean f852b = C0228a.m844a(System.getProperty("java.vm.version"));

    /* renamed from: android.support.multidex.a$a */
    private static final class C0225a {
        /* renamed from: a */
        private static final int f849a = ".zip".length();
        /* renamed from: b */
        private final C0224a f850b;

        /* renamed from: android.support.multidex.a$a$a */
        private interface C0224a {
            /* renamed from: a */
            Object mo170a(File file, DexFile dexFile);
        }

        /* renamed from: android.support.multidex.a$a$b */
        private static class C3071b implements C0224a {
            /* renamed from: a */
            private final Constructor<?> f13003a;

            C3071b(Class<?> cls) {
                this.f13003a = cls.getConstructor(new Class[]{File.class, ZipFile.class, DexFile.class});
                this.f13003a.setAccessible(true);
            }

            /* renamed from: a */
            public Object mo170a(File file, DexFile dexFile) {
                return this.f13003a.newInstance(new Object[]{file, new ZipFile(file), dexFile});
            }
        }

        /* renamed from: android.support.multidex.a$a$c */
        private static class C3072c implements C0224a {
            /* renamed from: a */
            private final Constructor<?> f13004a;

            C3072c(Class<?> cls) {
                this.f13004a = cls.getConstructor(new Class[]{File.class, File.class, DexFile.class});
                this.f13004a.setAccessible(true);
            }

            /* renamed from: a */
            public Object mo170a(File file, DexFile dexFile) {
                return this.f13004a.newInstance(new Object[]{file, file, dexFile});
            }
        }

        /* renamed from: android.support.multidex.a$a$d */
        private static class C3073d implements C0224a {
            /* renamed from: a */
            private final Constructor<?> f13005a;

            C3073d(Class<?> cls) {
                this.f13005a = cls.getConstructor(new Class[]{File.class, Boolean.TYPE, File.class, DexFile.class});
                this.f13005a.setAccessible(true);
            }

            /* renamed from: a */
            public Object mo170a(File file, DexFile dexFile) {
                return this.f13005a.newInstance(new Object[]{file, Boolean.FALSE, file, dexFile});
            }
        }

        /* renamed from: a */
        static void m831a(ClassLoader classLoader, List<? extends File> list) {
            Object obj = C0228a.m846b(classLoader, "pathList").get(classLoader);
            Object[] a = new C0225a().m832a((List) list);
            try {
                C0228a.m848b(obj, "dexElements", a);
            } catch (Throwable e) {
                Log.w("MultiDex", "Failed find field 'dexElements' attempting 'pathElements'", e);
                C0228a.m848b(obj, "pathElements", a);
            }
        }
...
*/
            ...
            r1 = new android.support.multidex.a$a$b;	 Catch:{ NoSuchMethodException -> 0x000f }
            r1.<init>(r0);	 Catch:{ NoSuchMethodException -> 0x000f }
            goto L_0x001a;
        L_0x000f:
            r1 = new android.support.multidex.a$a$c;	 Catch:{ NoSuchMethodException -> 0x0015 }
            r1.<init>(r0);	 Catch:{ NoSuchMethodException -> 0x0015 }
            goto L_0x001a;
        L_0x0015:
            r1 = new android.support.multidex.a$a$d;
            r1.<init>(r0);
        L_0x001a:
            r2.f850b = r1;
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.multidex.a.a.<init>():void");
        }

        /* renamed from: a */
        private Object[] m832a(List<? extends File> list) {
            Object[] objArr = new Object[list.size()];
            for (int i = 0; i < objArr.length; i++) {
                File file = (File) list.get(i);
                objArr[i] = this.f850b.mo170a(file, DexFile.loadDex(file.getPath(), C0225a.m830a(file), 0));
            }
            return objArr;
        }

        /* renamed from: a */
        private static String m830a(File file) {
            File parentFile = file.getParentFile();
            file = file.getName();
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(file.substring(0, file.length() - f849a));
    ...
    private static final class C0226b {
        /* renamed from: a */
        static void m833a(ClassLoader classLoader, List<? extends File> list, File file) {
            Object obj = C0228a.m846b(classLoader, "pathList").get(classLoader);
            ArrayList arrayList = new ArrayList();
            C0228a.m848b(obj, "dexElements", C0226b.m834a(obj, new ArrayList(list), file, arrayList));
            if (arrayList.size() > null) {
                ...
                list = C0228a.m846b(obj, "dexElementsSuppressedExceptions");
        ...
        /* renamed from: a */
        private static Object[] m834a(Object obj, ArrayList<File> arrayList, File file, ArrayList<IOException> arrayList2) {
            return (Object[]) C0228a.m847b(obj, "makeDexElements", ArrayList.class, File.class, ArrayList.class).invoke(obj, new Object[]{arrayList, file, arrayList2});
        }
    }
    ...
    private static final class C0227c {
        /* renamed from: a */
        static void m835a(ClassLoader classLoader, List<? extends File> list) {
            int size = list.size();
            Field a = C0228a.m846b(classLoader, "path");
            ...
            C0228a.m848b((Object) classLoader, "mPaths", objArr);
            C0228a.m848b((Object) classLoader, "mFiles", objArr2);
            C0228a.m848b((Object) classLoader, "mZips", objArr3);
            C0228a.m848b((Object) classLoader, "mDexs", objArr4);
        }
    }
    ...
    public static void m839a(Context context) {
        ...
        if (f852b) {
            ...
            try {
                ApplicationInfo b = C0228a.m845b(context);
                if (b == null) {
                    Log.i("MultiDex", "No ApplicationInfo available, i.e. running on a test Context: MultiDex support library is disabled.");
                    return;
                }
                C0228a.m840a(context, new File(b.sourceDir), new File(b.dataDir), "secondary-dexes", "", true);
    ...
    /* renamed from: a */
    private static void m840a(android.content.Context r5, java.io.File r6, java.io.File r7, java.lang.String r8, java.lang.String r9, boolean r10) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x005b:
        ...
        return;
    L_0x0064:
        android.support.multidex.C0228a.m849c(r5);	 Catch:{ Throwable -> 0x0068 }
        goto L_0x0070;
    L_0x0068:
        r2 = move-exception;
    ...
    L_0x0070:
        r7 = android.support.multidex.C0228a.m836a(r5, r7, r8);	 Catch:{ all -> 0x00af }
        r8 = new android.support.multidex.MultiDexExtractor;	 Catch:{ all -> 0x00af }
        r8.<init>(r6, r7);	 Catch:{ all -> 0x00af }
        r6 = 0;
        r2 = 0;
        r2 = r8.m828a(r5, r9, r2);	 Catch:{ all -> 0x00a0 }
        android.support.multidex.C0228a.m842a(r1, r7, r2);	 Catch:{ IOException -> 0x0083 }
        goto L_0x0095;
    L_0x0083:
        r2 = move-exception;
    ...
    L_0x0086:
        ...
        r5 = r8.m828a(r5, r9, r10);	 Catch:{ all -> 0x00a0 }
        android.support.multidex.C0228a.m842a(r1, r7, r5);	 Catch:{ all -> 0x00a0 }
    L_0x0095:
    ...
    L_0x00af:
        ...
        throw r5;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.multidex.a.a(android.content.Context, java.io.File, java.io.File, java.lang.String, java.lang.String, boolean):void");
    }

    /* renamed from: b */
    private static ApplicationInfo m845b(Context context) {
        try {
    ...
    /* renamed from: a */
    static boolean m844a(java.lang.String r5) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    /* renamed from: a */
    private static void m842a(ClassLoader classLoader, File file, List<? extends File> list) {
        if (!list.isEmpty()) {
            if (VERSION.SDK_INT >= 19) {
                C0226b.m833a(classLoader, list, file);
            } else if (VERSION.SDK_INT >= 14) {
                C0225a.m831a(classLoader, list);
            } else {
                C0227c.m835a(classLoader, list);
            }
        }
    }

    /* renamed from: b */
    private static java.lang.reflect.Field m846b(java.lang.Object r3, java.lang.String r4) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    /* renamed from: b */
    private static java.lang.reflect.Method m847b(java.lang.Object r3, java.lang.String r4, java.lang.Class<?>... r5) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    /* renamed from: b */
    private static void m848b(Object obj, String str, Object[] objArr) {
        str = C0228a.m846b(obj, str);
    ...
    /* renamed from: c */
    private static void m849c(Context context) {
    ...
    /* renamed from: a */
    private static java.io.File m836a(android.content.Context r2, java.io.File r3, java.lang.String r4) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
        ...
        r1 = "code_cache";
        r0.<init>(r3, r1);
        android.support.multidex.C0228a.m841a(r0);	 Catch:{ IOException -> 0x000b }
        goto L_0x0019;
    L_0x000b:
        r0 = new java.io.File;
        r2 = r2.getFilesDir();
        r3 = "code_cache";
        r0.<init>(r2, r3);
        android.support.multidex.C0228a.m841a(r0);
    L_0x0019:
        r2 = new java.io.File;
        r2.<init>(r0, r4);
        android.support.multidex.C0228a.m841a(r2);
        return r2;
        */
    ...
    /* renamed from: a */
    private static void m841a(File file) {
        file.mkdir();
        if (!file.isDirectory()) {
