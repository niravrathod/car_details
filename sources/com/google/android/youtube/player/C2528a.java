...
*/
        /*
        r0 = r3.getPackageManager();	 Catch:{ NameNotFoundException -> 0x002f }
        r1 = com.google.android.youtube.player.internal.ab.m12467a(r3);	 Catch:{ NameNotFoundException -> 0x002f }
        r2 = 64;	 Catch:{ NameNotFoundException -> 0x002f }
        r2 = r0.getPackageInfo(r1, r2);	 Catch:{ NameNotFoundException -> 0x002f }
        r2 = com.google.android.youtube.player.C2528a.m12458a(r2);	 Catch:{ NameNotFoundException -> 0x002f }
        if (r2 != 0) goto L_0x0017;	 Catch:{ NameNotFoundException -> 0x002f }
    L_0x0014:
        r3 = com.google.android.youtube.player.YouTubeInitializationResult.f10854g;	 Catch:{ NameNotFoundException -> 0x002f }
        return r3;	 Catch:{ NameNotFoundException -> 0x002f }
    L_0x0017:
        r3 = com.google.android.youtube.player.internal.ab.m12468a(r3, r1);	 Catch:{ NameNotFoundException -> 0x002f }
        if (r3 == 0) goto L_0x0020;	 Catch:{ NameNotFoundException -> 0x002f }
    L_0x001d:
        r3 = com.google.android.youtube.player.YouTubeInitializationResult.f10852e;	 Catch:{ NameNotFoundException -> 0x002f }
        return r3;	 Catch:{ NameNotFoundException -> 0x002f }
    L_0x0020:
        r3 = 0;	 Catch:{ NameNotFoundException -> 0x002f }
        r3 = r0.getApplicationInfo(r1, r3);	 Catch:{ NameNotFoundException -> 0x002f }
        r3 = r3.enabled;	 Catch:{ NameNotFoundException -> 0x002f }
        if (r3 != 0) goto L_0x002c;	 Catch:{ NameNotFoundException -> 0x002f }
    L_0x0029:
        r3 = com.google.android.youtube.player.YouTubeInitializationResult.SERVICE_DISABLED;	 Catch:{ NameNotFoundException -> 0x002f }
        return r3;	 Catch:{ NameNotFoundException -> 0x002f }
    L_0x002c:
        r3 = com.google.android.youtube.player.YouTubeInitializationResult.SUCCESS;	 Catch:{ NameNotFoundException -> 0x002f }
        return r3;
    L_0x002f:
        r3 = com.google.android.youtube.player.YouTubeInitializationResult.SERVICE_MISSING;
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.youtube.player.a.a(android.content.Context):com.google.android.youtube.player.YouTubeInitializationResult");
    }

    /* renamed from: a */
    private static boolean m12458a(android.content.pm.PackageInfo r4) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
        /*
        r0 = 0;
        r1 = "X509";	 Catch:{ CertificateException -> 0x0040 }
        r1 = java.security.cert.CertificateFactory.getInstance(r1);	 Catch:{ CertificateException -> 0x0040 }
        r2 = new java.io.ByteArrayInputStream;	 Catch:{ CertificateException -> 0x0040 }
        r3 = r4.signatures;	 Catch:{ CertificateException -> 0x0040 }
        r3 = r3[r0];	 Catch:{ CertificateException -> 0x0040 }
        r3 = r3.toByteArray();	 Catch:{ CertificateException -> 0x0040 }
        r2.<init>(r3);	 Catch:{ CertificateException -> 0x0040 }
        r1 = r1.generateCertificate(r2);	 Catch:{ CertificateException -> 0x0040 }
        r1 = (java.security.cert.X509Certificate) r1;	 Catch:{ CertificateException -> 0x0040 }
        r1.checkValidity();	 Catch:{ CertificateException -> 0x0040 }
        r1 = r4.signatures;
        r1 = r1.length;
        r2 = 1;
    ...
    L_0x0040:
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.youtube.player.a.a(android.content.pm.PackageInfo):boolean");
    }
}
