...
/* renamed from: com.cuvora.carinfo.b.p */
public class C4855p extends C4795o implements C1489a {
    /* renamed from: h */
    private static final C0052b f21520h = null;
    /* renamed from: i */
    private static final SparseIntArray f21521i = null;
    /* renamed from: j */
    private final OnClickListener f21522j;
    /* renamed from: k */
    private long f21523k;

    public C4855p(C0059e c0059e, View view) {
        this(c0059e, view, ViewDataBinding.m24012a(c0059e, view, 3, f21520h, f21521i));
    }

    private C4855p(C0059e c0059e, View view, Object[] objArr) {
        ...
        this.e.setTag(null);
        m24022a(view);
        this.f21522j = new C1490a(this, 1);
        mo4906h();
    }
    ...
    public boolean mo4903a(int i, Object obj) {
        if (2 == i) {
            ...
            m28792a((HomeFragmentViewModel) obj);
        }
        return true;
    }

    /* renamed from: a */
    public void m28791a(C3730d c3730d) {
        this.f = c3730d;
        synchronized (this) {
            this.f21523k |= 1;
        }
    ...
    /* renamed from: a */
    public void m28792a(HomeFragmentViewModel homeFragmentViewModel) {
    ...
    protected void mo4904b() {
        ...
        if ((j & 4) != 0) {
            this.e.setOnClickListener(this.f21522j);
        }
    }
